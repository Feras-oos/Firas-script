-- سكربت Brookhaven RP المعدل مع خاصية إظهار/إخفاء النافذة
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Robojini/Tuturial_UI_Library/main/UI_Template_1"))()
local Window = Library.CreateLib("DmitryHack | Brookhaven RP", "RJTheme3")

-- إضافة زر للتحكم في إظهار/إخفاء النافذة
...
-- وظيفة إظهار/إخفاء النافذة
toggleButton.MouseButton1Click:Connect(function()
    guiVisible = not guiVisible
    if guiVisible then
        -- إظهار النافذة الرئيسية
        for _, v in pairs(game.CoreGui:GetChildren()) do
            if v:IsA("ScreenGui") and v.Name ~= screenGui.Name then
                v.Enabled = true
            end
        end
        toggleButton.Text = "≡"
...
Section:NewButton("Drones", "", function()
    if game:GetService("Workspace"):FindFirstChild("Model") and game.Workspace.Model:FindFirstChild("DroneFakeNew") then
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "خطأ",
            Text = "لم يتم العثور على موقع Drones",
            Duration = 3
        })
    end
end)
...
Section:NewButton("School", "", function()
    if game:GetService("Workspace"):FindFirstChild("Model") and game.Workspace.Model:FindFirstChild("Desks") then
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "خطأ",
            Text = "لم يتم العثور على موقع School",
            Duration = 3
        })
    end
end)
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    ...
    Text = "اضغط على الزر الأحمر لإظهار/إخفاء النافذة",
    Duration = 5
})
